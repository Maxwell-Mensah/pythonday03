import random #outils qui permettra de générer aléatoirement un nombre dans un intervalle donné
    ...
    def befriend(self, other):
        ...
        if type(other)==Cat: 
            if self.energy<25:
                ...
                num=random.randint(1,6) #tirage d'un nombre aléatoirement entre 1 et 6
                if num==1:
