class Cat:
    def __init__(self, name=None, age=None, energy=100 ):
        self.name=name
        self.age=age
        self.energy=energy #ajout d'un nouvel attribut
        if name:
    ...
    #création d'une méthode pour avoir l'attribut energy d'un objet existant     
    def get_energy(self):
        return self.energy
    
    
    #création d'une méthode permettant de modifier l'attribut energy d'un objet
